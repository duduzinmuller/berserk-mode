    ...
    >
      <div className='container mx-auto flex items-center justify-between px-4'>
        ...
        <div className='flex items-center space-x-4'>
          <a
            href='#'
            className='p-2 rounded-full border border-white/50 hover:bg-[#FF0000]'
          >
            <img src={NavIcon} alt='YouTube' className='h-5 w-5' />
          </a>
          <a
            href='#'
            className='p-2 rounded-full border border-white/50 hover:bg-gradient-to-r hover:from-[#F58529] hover:to-[#E4405F]'
          >
